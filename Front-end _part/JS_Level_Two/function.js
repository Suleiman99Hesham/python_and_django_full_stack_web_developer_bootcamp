...
function sleepIn(weekday = true, vacation = true) {
    //Code Goes Here
...
function monkeyTrouble(aSmile = true, bSmile = true) {
    //Code Goes Here
...
function caught_speeding(speed = 0, is_birthday = true){
  //Code Goes Here
  var birthdayCost = 0;
  if (is_birthday == true) {
    birthdayCost = -5;
...
function makeBricks(small = 0, big = 0, goal = 0){
  //Code Goes Here
